...
\noindent  \textcolor{gray}{\large Audun Sørheim} \\
\vspace{1cm}

\noindent \textbf{\Large Misinformation...} \\
\vspace{0.5cm}
...
Supervisor: Astrid Silvia de Wijn \\
...
\chapter{Msinformation, Human Behavior and Modelling}
\input{Chapters/04SociologyTheory}
\cleardoublepage

\chapter{Graphs}
\input{Chapters/045GraphTheory}
\cleardoublepage

\chapter{Distributed Hypothesis Testing Model}
\input{Chapters/05ModelTheory}
\cleardoublepage
